...
$works = [
    [
        ...
        "dateStart" => "Сенттябрь 2015",
        "dateEnd" => "Июнь 2017",
        "description" => "Полное техническое обеспечение безперебойной работы компании",
    ],
    [
      "name" => "Директор",
      "dateStart" => "Август 2017",
      "dateEnd" => "Январь 20201",
      "description" => "Руководство волгограддским подразделением Самарской масло-хладо бойни на артельных началах.",
    ],
    [
      "name" => "Руководитель компании",
      "dateStart" => "Март 2021",
      "dateEnd" => "по настоящее время",
      "description" => "Руководство международной транспортно-логистической фирмой.",
  ],
];
